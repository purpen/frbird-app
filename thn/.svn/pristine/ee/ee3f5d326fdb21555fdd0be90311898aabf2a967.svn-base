...
+ (JDStatusBarStyle*)defaultStyleWithName:(NSString*)styleName;
{
    ...
    // JDStatusBarStyleMatrix
        ...
        style.barColor = [UIColor colorWithRed:248/255.0 green:248/255.0 blue:248/255.0 alpha:1.0];
        style.textColor = [UIColor colorWithRed:41/255.0 green:41/255.0 blue:41/255.0 alpha:1.0];
