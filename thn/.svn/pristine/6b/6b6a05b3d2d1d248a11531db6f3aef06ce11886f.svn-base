...
#define AlertTitleColor [UIColor colorWithRed:37/255.0 green:37/255.0 blue:37/255.0 alpha:1.0]
#define AlertMessageColor [UIColor colorWithRed:37/255.0 green:37/255.0 blue:37/255.0 alpha:1.0]
...
-(void)prepareLoadingToDisplay:(XYLoadingView*)entity
{
    ...
    if(!_blackBG)
    {
        ...
        _blackBG.backgroundColor = [UIColor clearColor];
        _blackBG.opaque = YES;
        _blackBG.alpha = 0.5f;
...
-(void)prepareAlertToDisplay:(XYAlertView*)entity
{
    ...
    _messageLabel.textColor = AlertMessageColor;
